/*
  ...
  - You are about to drop the column `is_active` on the `scheduledetail` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `scheduledetail` DROP COLUMN `is_active`;
