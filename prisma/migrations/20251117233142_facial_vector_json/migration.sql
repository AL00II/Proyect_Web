/*
  ...
  - You are about to alter the column `facial_vector` on the `employee` table. The data in that column could be lost. The data in that column will be cast from `VarChar(191)` to `Json`.
...
-- AlterTable
ALTER TABLE `employee` MODIFY `facial_vector` JSON NULL;
